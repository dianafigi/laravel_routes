...
Route::get('/nome/{nome}/{maisum}', function ($nome, $oi) { //o $nome e $oi dentro da funçao tem de ser igual ao q está no return. Nao tem de ser igual ao q esta no get()
...
Route::get('/semregra/{nome?}', function ($nome=null) {  //com o '?' defino o parametro como opcional. Entao tenho de definir tambem -> como null por defeito
...
Route::prefix('app')->group(function() {
  ...
  Route::get("profile", function() {
    return "págia profile";  //return view('profile') -> criando nas views o ficheiro profile.blade.php faz o return da view
  });
  Route::get("about", function() {
    return "págia about ";
  });//->name('app.about');    //se fizer isto (renomear rotas), na view fica: <a href="{{route('app.about')}}">About</a>
});
...
Route::redirect('/aqui', '/hey', 301); //redirecciona a pagina 'aqui' para  a 'hey' e o 301 é codigo de retorno http q informa que 'aqui' está agora em 'hey'
    //Metodo 2:
Route::get('todososprodutos1', function() {
  return redirect()->route('meusprodutos'); //usar o name e nao o nome da rota
});
...
//NOMEAR ROTAS  ->util se alguem mudar a rota (mudar 'produtos' p/ outra coisa qq), se se estiver a utilizar o nome 'meusprodutos', a rota vai funcionar sempre
//              ->na view fica: <a href="{{route('meusprodutos')}}">Produtor</a>
